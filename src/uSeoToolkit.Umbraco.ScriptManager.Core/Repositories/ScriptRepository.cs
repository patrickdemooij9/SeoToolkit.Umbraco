    ...
    public class ScriptRepository : IScriptRepository
    {
        ...
        private ScriptEntity ToEntity(Script script)
        {
            return new ScriptEntity
            {
                ...
                DocumentTypes = string.Join(",", script.DocumentTypeIds),
                Config = JsonSerializer.Serialize(script.Config.Values)
            };
        }
        ...
        private Script ToModel(ScriptEntity entity)
        {
            return new Script
            {
                ...
                Config = new ScriptConfig(JsonSerializer.Deserialize<Dictionary<string, string>>(entity.Config))
            };
        }
    }
}
