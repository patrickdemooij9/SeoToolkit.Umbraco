...
var g = (t, e, o) => (x(t, e, "read from private field"), o ? o.call(t) : e.get(t)), w = (t, e, o) => e.has(t) ? D("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, o), _ = (t, e, o, r) => (x(t, e, "write to private field"), r ? r.call(t, o) : e.set(t, o), o);
import { LitElement as W, html as u, when as y, repeat as F, css as K, state as G, customElement as V } from "@umbraco-cms/backoffice/external/lit";
  ...
  try {
    ...
    if (!s.isCancelled) {
      ...
      for (const $ of t.interceptors.response._fns)
        l = await $(l);
      const I = await pe(l), L = he(l, e.responseHeader);
      let O = I;
...
T = new WeakMap();
const E = "seoToolkit_tree_root", h = "seoToolkit-module", M = "seoToolkit_tree_store_context";
class Je extends j {
  constructor(e) {
    super(e), this.workspaceAlias = "seoToolkit.module.workspace", this.provideContext(q, this), this.provideContext(X, this);
  }
  getEntityType() {
    return h;
  }
...
var be = Object.defineProperty, Se = Object.getOwnPropertyDescriptor, P = (t, e, o, r) => {
  for (var s = r > 1 ? void 0 : r ? Se(e, o) : e, n = t.length - 1, i; n >= 0; n--)
    (i = t[n]) && (s = (r ? i(e, o, s) : i(s)) || s);
  return r && s && be(e, o, s), s;
};
let m = class extends z(W) {
  constructor() {
    super(), this.consumeContext(q, () => {
      console.log("Hello?");
    });
  }
  connectedCallback() {
...
const H = m, ke = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
const B = () => k.getUmbracoSeoToolkitTreeInfoRoot(), _e = (t) => t.parent.unique === null ? B() : k.getUmbracoSeoToolkitTreeInfoChildren({
  parentId: t.parent.unique,
  skip: t.skip,
  take: t.take
}), Ce = (t) => k.getUmbracoSeoToolkitTreeInfoAncestors({
...
const Ae = {
  ...
  element: () => import("./seoToolkitModuleWorkspace.element-BeYSVewh.js"),
  meta: {
    entityType: h
  }
}, Me = {
...
const Pe = {
  ...
  }), e.register(re), e.register(Ee), e.register(ge), e.register(Pe), e.registerMany([Ae, xe, De, Ue, ve, je, Ne, Me]);
};
export {
  Je as S,
  Xe as o
};
//# sourceMappingURL=index-CxlLiiUm.js.map
