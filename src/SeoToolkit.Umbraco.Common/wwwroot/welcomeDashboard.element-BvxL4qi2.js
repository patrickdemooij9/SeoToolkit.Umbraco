...
var C = (t, e, r) => e.has(t) || j("Cannot " + r);
var b = (t, e, r) => (C(t, e, "read from private field"), r ? r.call(t) : e.get(t)), g = (t, e, r) => e.has(t) ? j("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), R = (t, e, r, o) => (C(t, e, "write to private field"), o ? o.call(t, r) : e.set(t, r), r);
...
import { O as B } from "./index-YVq28pKm.js";
...
let u = class extends U(q) {
  constructor() {
    super(), new re(this).getModules().then((t) => {
      this.modules = t.data;
    });
  }
  render() {
...
//# sourceMappingURL=welcomeDashboard.element-BvxL4qi2.js.map
