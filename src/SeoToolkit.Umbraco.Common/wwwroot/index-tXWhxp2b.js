...
var w = (t, e, o) => (v(t, e, "read from private field"), o ? o.call(t) : e.get(t)), g = (t, e, o) => e.has(t) ? D("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, o), _ = (t, e, o, s) => (v(t, e, "write to private field"), s ? s.call(t, o) : e.set(t, o), o);
import { LitElement as K, html as u, when as y, repeat as V, css as G, state as z, customElement as J } from "@umbraco-cms/backoffice/external/lit";
...
const d = {
...
}, f = (t) => typeof t == "string", C = (t) => f(t) && t !== "", R = (t) => t instanceof Blob, q = (t) => t instanceof FormData, ae = (t) => {
  try {
    return btoa(t);
  } catch {
  ...
  if (t.formData) {
    const e = new FormData(), o = (s, r) => {
      f(r) || R(r) ? e.append(s, r) : e.append(s, JSON.stringify(r));
    };
  ...
  try {
    ...
    if (!r.isCancelled) {
      ...
      for (const F of t.interceptors.response._fns)
        l = await F(l);
      const I = await Te(l), $ = he(l, e.responseHeader);
      let A = I;
...
class ye {
  ...
  async getModules() {
    return await Y(w(this, h), S.getUmbracoSeoToolkitModules());
  }
}
h = new WeakMap();
var T;
...
T = new WeakMap();
const E = "seoToolkit_tree_root", p = "seoToolkit-module", P = "seoToolkit_tree_store_context";
class ke extends M {
  constructor(e) {
...
var Ee = Object.defineProperty, we = Object.getOwnPropertyDescriptor, B = (t, e, o, s) => {
  for (var r = s > 1 ? void 0 : s ? we(e, o) : e, n = t.length - 1, i; n >= 0; n--)
    (i = t[n]) && (r = (s ? i(e, o, r) : i(r)) || r);
  return s && r && Ee(e, o, r), r;
};
let m = class extends X(K) {
  constructor() {
...
const W = m, H = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
const L = () => S.getUmbracoSeoToolkitTreeInfoRoot(), Re = (t) => t.parent.unique === null ? L() : S.getUmbracoSeoToolkitTreeInfoChildren({
...
const De = {
  ...
  element: () => import("./seoToolkitModuleWorkspace.element-CNC8b4Cj.js"),
  meta: {
    entityType: p
  }
}, Pe = {
...
//# sourceMappingURL=index-tXWhxp2b.js.map
