...
import { S as c } from "./index-CNNHqxCp.js";
...
class d extends E {
  constructor(e) {
    super(e), this.workspaceAlias = "seoToolkit.module.workspace", this.provideContext(_, this), this.provideContext(a, this);
  }
  getEntityType() {
    return c;
  }
...
let n = class extends m(p) {
  constructor() {
    super(...arguments), this._workspaceContext = new d(this);
  }
  render() {
    return u`
...
//# sourceMappingURL=seoToolkitModuleWorkspace.element-DZYp1ivZ.js.map
