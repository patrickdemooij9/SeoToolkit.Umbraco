...
var x = (t, e, r) => e.has(t) || C("Cannot " + r);
var b = (t, e, r) => (x(t, e, "read from private field"), r ? r.call(t) : e.get(t)), g = (t, e, r) => e.has(t) ? C("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), w = (t, e, r, o) => (x(t, e, "write to private field"), o ? o.call(t, r) : e.set(t, r), r);
...
import { O as B } from "./index-BBFQYrR2.js";
...
const f = (t) => typeof t == "string", R = (t) => f(t) && t !== "", T = (t) => t instanceof Blob, j = (t) => t instanceof FormData, L = (t) => {
  try {
    return btoa(t);
  } catch {
  ...
  return e.body !== void 0 && (e.mediaType ? n["Content-Type"] = e.mediaType : T(e.body) ? n["Content-Type"] = e.body.type || "application/octet-stream" : f(e.body) ? n["Content-Type"] = "text/plain" : j(e.body) || (n["Content-Type"] = "application/json")), new Headers(n);
}, V = (t) => {
  var e, r;
  if (t.body !== void 0)
    return (e = t.mediaType) != null && e.includes("application/json") || (r = t.mediaType) != null && r.includes("+json") ? JSON.stringify(t.body) : f(t.body) || T(t.body) || j(t.body) ? t.body : JSON.stringify(t.body);
...
//# sourceMappingURL=welcomeDashboard.element-CebMxF81.js.map
