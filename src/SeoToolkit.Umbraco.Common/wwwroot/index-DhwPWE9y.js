...
var E = (t, e, o) => (v(t, e, "read from private field"), o ? o.call(t) : e.get(t)), g = (t, e, o) => e.has(t) ? D("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, o), _ = (t, e, o, r) => (v(t, e, "write to private field"), r ? r.call(t, o) : e.set(t, o), o);
...
class ye {
  ...
  async getModules() {
    return await X(E(this, h), S.getUmbracoSeoToolkitModules());
  }
}
h = new WeakMap();
var T;
...
T = new WeakMap();
const w = "seoToolkit_tree_root", p = "seoToolkit-module", q = "seoToolkit_tree_store_context";
class ke extends M {
  constructor(e) {
...
var we = Object.defineProperty, Ee = Object.getOwnPropertyDescriptor, P = (t, e, o, r) => {
  for (var s = r > 1 ? void 0 : r ? Ee(e, o) : e, n = t.length - 1, i; n >= 0; n--)
    (i = t[n]) && (s = (r ? i(e, o, s) : i(s)) || s);
  return r && s && we(e, o, s), s;
};
...
const B = () => S.getUmbracoSeoToolkitTreeInfoRoot(), Re = (t) => t.parent.unique === null ? B() : S.getUmbracoSeoToolkitTreeInfoChildren({
...
const De = {
  ...
  element: () => import("./seoToolkitModuleWorkspace.element-QgQeeYvj.js"),
  meta: {
    entityType: p
  }
}, Pe = {
...
const Le = {
  ...
  }), e.register(se), e.register(ge), e.register(_e), e.register(Le), e.registerMany([De, je, ve, Ue, Me, Ne, qe, We, He, Pe]);
};
export {
  ke as S,
  Ze as o
};
//# sourceMappingURL=index-DhwPWE9y.js.map
