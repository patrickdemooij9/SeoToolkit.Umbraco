...
import { S as D } from "./index-D9xuaTHa.js";
...
class le extends N {
  constructor(r) {
    ...
    h(this, l);
    h(this, R);
    this.workspaceAlias = "seoToolkit.context.robotsTxtModule", f(this, l, new H("")), this.content = d(this, l).asObservable(), f(this, R, new L([], (s) => s.error)), this.validationErrors = d(this, R).asObservable(), f(this, p, new te(r)), this.provideContext(re, this), this.provideContext(B, this), d(this, p).getContent().then((s) => {
...
//# sourceMappingURL=RobotsTxtModuleContext-xV2ULmz2.js.map
