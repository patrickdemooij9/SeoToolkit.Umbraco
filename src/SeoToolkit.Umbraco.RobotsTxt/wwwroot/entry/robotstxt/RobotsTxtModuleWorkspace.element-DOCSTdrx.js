...
import { LitElement as b, html as n, when as d, repeat as h, css as m, state as u, customElement as v } from "@umbraco-cms/backoffice/external/lit";
import { ST_ROBOTSTXT_MODULE_TOKEN_CONTEXT as x } from "./RobotsTxtModuleContext-CC2Ym4ee.js";
  ...
  render() {
    return n`
      ...
      value: 10
                    ...
                    ${d(this._validationErrors.length > 0, () => n`
                        <h5>Validation Errors</h5>
                            ${h(this._validationErrors, (o) => o.error, (o) => n`
                            <p class="error">
...
//# sourceMappingURL=RobotsTxtModuleWorkspace.element-DOCSTdrx.js.map
