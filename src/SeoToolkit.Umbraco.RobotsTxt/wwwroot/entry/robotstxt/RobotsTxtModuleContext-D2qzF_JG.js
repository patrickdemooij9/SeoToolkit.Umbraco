...
import { S as D } from "./index-PI_c4Qn4.js";
import { UmbStringState as H, UmbArrayState as L } from "@umbraco-cms/backoffice/observable-api";
...
}, S = (t) => typeof t == "string", g = (t) => S(t) && t !== "", C = (t) => t instanceof Blob, U = (t) => t instanceof FormData, G = (t) => {
  try {
    return btoa(t);
  } catch {
...
}, y = (t, e) => new F(async (r, s, o) => {
  try {
    const n = K(t, e), i = W(e), a = J(e), u = await z(t, e);
    if (!o.isCancelled) {
      let c = await X(t, e, n, a, i, u, o);
      for (const P of t.interceptors.response._fns)
        c = await P(c);
      const _ = await Y(c), I = Q(c, e.responseHeader);
      let w = _;
...
class ee {
  ...
  async getContent() {
    return await A(d(this, b), q.getUmbracoSeoToolkitRobotsTxt());
  }
  async saveContent(e) {
    return await A(d(this, b), q.postUmbracoSeoToolkitRobotsTxt({
      requestBody: {
        skipValidation: !1,
        content: e
      }
...
class le extends N {
  constructor(r) {
    ...
    h(this, l);
    h(this, R);
    this.workspaceAlias = "seoToolkit.context.robotsTxtModule", f(this, l, new H("")), this.content = d(this, l).asObservable(), f(this, R, new L([], (s) => s.error)), this.validationErrors = d(this, R).asObservable(), this.provideContext(re, this), this.provideContext(B, this), f(this, p, new te(r)), d(this, p).getContent().then((s) => {
...
export {
  re as ST_ROBOTSTXT_MODULE_TOKEN_CONTEXT,
  le as default
};
//# sourceMappingURL=RobotsTxtModuleContext-D2qzF_JG.js.map
