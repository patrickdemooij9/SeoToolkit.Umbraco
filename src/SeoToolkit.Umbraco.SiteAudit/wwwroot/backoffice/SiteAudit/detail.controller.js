(function () {
    ...
    function siteAuditDetailController($timeout, $routeParams, $http, $location, siteAuditHub, localizationService, overlayService) {
        ...
        function loadCurrentAudit(id) {
            $http.get("backoffice/SeoToolkit/SiteAudit/Connect?auditId=" + id + "&clientId=" + getClientId()).then(function (response) {
    ...
    angular.module("umbraco").controller("SeoToolkit.SiteAudit.DetailController", siteAuditDetailController);
})();