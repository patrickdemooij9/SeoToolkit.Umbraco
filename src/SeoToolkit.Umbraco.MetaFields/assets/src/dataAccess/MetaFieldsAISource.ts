...
import { BackofficeSeoToolkit, BackofficeSeoToolkitAiIntegration } from "../api";
...
export class MetaFieldsAISource {
  ...
  async isAvailable() {
    return tryExecute(this.#host, BackofficeSeoToolkit.getUmbracoSeoToolkitSettingsIsAiAvailable());
  }
