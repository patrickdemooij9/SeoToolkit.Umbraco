...
import ScriptManagerSortModal from "../modals/ScriptManagerSortModal.element";
...
const ScriptManagerSortModalManifest: ManifestModal = {
  type: "modal",
  alias: "seoToolkit.modal.scriptManager.sort",
  name: "SeoToolkit ScriptManager Sort Modal",
  js: ScriptManagerSortModal,
};

export const CollectionManifests = [
  ScriptManagerCollection,
  ScriptManagerCollectionView,
  ScriptManagerCollectionCreateAction,
  ScriptManagerCollectionTrashBulkAction,
  ScriptManagerRepository,
  ScriptManagerSortCollectionAction,
  ScriptManagerSortModalManifest,
];
