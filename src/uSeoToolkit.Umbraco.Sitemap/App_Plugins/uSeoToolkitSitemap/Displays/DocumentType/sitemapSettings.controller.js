(function () {
    ...
    function SitemapSettingsController($scope, $http, editorState, notificationsService) {
        ...
        function init() {
            $http.get("backoffice/uSeoToolkit/SitemapSettings/GetPageTypeSettings?contentTypeId=" + editorState.getCurrent().id)
        ...
        function save() {
            $http.post("backoffice/uSeoToolkit/SitemapSettings/SetPageTypeSettings",
                {
    ...
    angular.module("umbraco").controller("uSeoToolkit.Displays.SitemapSettingsController", SitemapSettingsController);
})();